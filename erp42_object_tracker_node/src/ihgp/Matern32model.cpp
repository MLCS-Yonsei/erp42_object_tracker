...
Eigen::MatrixXd Matern32model::getF()
{
    return F;
}

Eigen::MatrixXd Matern32model::getPinf()
{
    return Pinf;
}

Eigen::MatrixXd Matern32model::getH()
{
    return H;
}
...
std::vector< Eigen::MatrixXd > Matern32model::getdF()
{
   return dF;
}

std::vector< Eigen::MatrixXd > Matern32model::getdPinf()
{
    return dPinf;
}

std::vector< double > Matern32model::getdR()
{
    return dR;
}
